...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 text-sm font-medium">Tenants Activos</p>
                    <p class="text-3xl font-bold text-gray-800 mt-1">{{ $tenants->where('status', 'active')->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 text-sm font-medium">En Prueba</p>
                    <p class="text-3xl font-bold text-gray-800 mt-1">{{ $tenants->filter(fn($t) => $t->isOnTrial())->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 text-sm font-medium">Con Suscripción</p>
                    <p class="text-3xl font-bold text-gray-800 mt-1">{{ $tenants->filter(fn($t) => $t->currentSubscription())->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-1">{{ $tenants->where('status', 'suspended')->count() }}</p>
                </div>
