...
<div class="bg-white rounded-lg shadow-md p-6">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Crear Nuevo Contacto</h2>
    </div>
    ...
    <form action="{{ route('contacts.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="phone" id="phone"
                    ...
                    value="{{ old('phone') }}" placeholder="+52 123 456 7890">
                @error('phone')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="whatsapp_id" id="whatsapp_id"
                    ...
                    value="{{ old('whatsapp_id') }}" placeholder="521234567890">
                @error('whatsapp_id')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="tags" id="tags"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    value="{{ old('tags') }}" placeholder="vip, premium, importante">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="custom_fields" id="custom_fields" rows="3"
                    ...
                    placeholder='{"birthday": "1990-05-15", "preferencia": "nocturno"}'>{{ old('custom_fields') }}</textarea>
                @error('custom_fields')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
        ...
        <div class="mt-6 flex items-center justify-end space-x-3">
            <a href="{{ route('contacts.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded">
                Cancelar
            </a>
